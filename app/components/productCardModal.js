...
// import { useCartItem } from './cartContext';
// import Confetti from "./confetti";
// // import { useNonceData } from '../components/nonceProvider';

// const CouponsModule = forwardRef((props, ref) => {
//     // const { cartGlobalItemData, updateGlobalCartData } = useCartItem();
//     // const { ensureNonce, fetchNonce } = useNonceData();
...
//                 // if(errorData.message === 'Nonce is invalid.'){
//                 //     console.log('Nonce is invalid. Updating...');
//                 //     await fetchNonce();
...
//     return (
//         <>
//             <div className={`px-5 py-3 `} onClick={toggleModal}>
//                 <div className="flex">
...
//                                                         {
//                                                             // cartGlobalItemData.coupons.length > 0 && (
//                                                                 coupon.code !== cartGlobalItemData?.coupons[0]?.code ? (
...
//                                                                             disabled={
//                                                                                 parseFloat(cartGlobalItemData.totals.total_price) < parseFloat(coupon.minimum_amount)
//                                                                             }
//                                                                         >
//                                                                             Apply
//                                                                         </button>
...
//                                                             Add items worth ₹{coupon.minimum_amount - cartGlobalItemData.totals.total_price} more to get this offer
//                                                         </p>
//                                                     ) : null
//                                                 }
...
// CouponsModule.displayName = 'MyComponent';
